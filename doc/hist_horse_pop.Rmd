...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1. Changes in horse populations in different provinces in Canada through time", fig.align='center'}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 2. Horse population over th years in the province of British Columbia", fig.align='center'}
